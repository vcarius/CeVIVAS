...
setwd("~/Documents/prj_influenza/PAPER/TREE/")
...
COLOURS = c("6B.1A.5a.1" = "#8dd3c7", "6B.1A.5a.2a" = "#e78ac3",    "6B.1A.5a.2" = "#bebada", "6B.1A.5a.2a.1" = "#80b1d3")

####################################
#    READ TREE and DATA 
####################################

MCCtree <- read.nexus("./H1N1/nextstrain__timetree_h1n1.nexus")
MDATA <- read.delim2("./H1N1/metadata2.txt")
...
lineage_COLOUR = c("6B.1A.5a.1" = "#8dd3c7", "6B.1A.5a.2a" = "#e78ac3", "6B.1A.5a.2" = "#bebada", "6B.1A.5a.2a.1" = "#80b1d3")
